...
def create_data_loaders(train_images, train_labels, test_images, test_labels, batch_size=64):
    ...
    train_dataset = LocalMNISTDataset(
        train_images, train_labels, transform=train_transform, extend_labels=True
    )
    test_dataset = LocalMNISTDataset(
        test_images, test_labels, transform=test_transform, extend_labels=True
    )
